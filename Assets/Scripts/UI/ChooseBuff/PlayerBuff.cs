...
public class PlayerBuff : MonoBehaviour
{
    ...
    protected virtual void OnEnable()
    {
        ...
        if(attributeManager.playerData.luck <= 10)
        {
            
        }

        int rarity = Random.Range(attributeManager.playerData.luck, Mathf.Min(65 + attributeManager.playerData.luck, 101));
        ...
        GetComponent<Image>().color = rarityColor[rarityLevel];
    }
